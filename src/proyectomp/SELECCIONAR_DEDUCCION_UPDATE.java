 ...
 * @author Calix
 */
public class SELECCIONAR_DEDUCCION_UPDATE extends javax.swing.JFrame {

    /**
     * Creates new form SELECCIONAR_DEDUCCION
     */
    public SELECCIONAR_DEDUCCION_UPDATE() {
        initComponents();
    ...
    map3.put(KeyStroke.getKeyStroke(KeyEvent.VK_V, Event.CTRL_MASK), "null");
        ...
        Funciones.setListarDEDUUpdatee("");
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtValor, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 60, 140, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 130, 730, 182));
        ...
        jPanel1.add(btbSelect, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 330, -1, 46));
...
//           Funciones.setListarJoinDeduUpdate(lbl.getText(), idPlanilla.getText());
...
//                this.txtFun.getText().length()==0){
            JOptionPane.showMessageDialog(null, "Ingrese el valor de la deduccion");
            
        } else {
           
           for (int i = 0; i < DETALLE_PLANILLAS_UPDATE.tbldedu.getRowCount(); i++) {
               String val = DETALLE_PLANILLAS_UPDATE.tbldedu.getValueAt(i, 0).toString();
               if (Id.equals(val)) {
                   a=1;
               }
           ...
           if (a>0) {
               ...
               DefaultTableModel m = (DefaultTableModel)DETALLE_PLANILLAS_UPDATE.tbldedu.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SELECCIONAR_DEDUCCION_UPDATE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SELECCIONAR_DEDUCCION_UPDATE().setVisible(true);
            }
        });
    }
