...
//import static proyectomp.MostrarProveedores.tblPro;
import static proyectomp.PROVEEDOR.tblPro;

/**
 *
 * @author espin
 */
public class COMPRA_MATERIA_PRIMA_UPDATE extends javax.swing.JFrame {

    /**
     * Creates new form COMPRA_MATERIA_PRIMA
     */
    public COMPRA_MATERIA_PRIMA_UPDATE() {
        initComponents();
    ...
    ctrl2.put(KeyStroke.getKeyStroke(KeyEvent.VK_V, Event.CTRL_MASK), "null");
        Funciones_Henry.setListarInventarioupdate("");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 410, 80, 20));

        lblTotal.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jPanel1.add(lblTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 410, 80, 20));
        ...
        if (String.valueOf(txtCantidad.getText()).compareTo("") == 0
					...
					JOptionPane.showMessageDialog(rootPane, "Ingrese la cantidad de producto", "Advertencia", JOptionPane.ERROR_MESSAGE);
                                    ...
                                    if (a>0) {
                                       ...
                                       //double other =  Double.parseDouble(lblTotal.getText());
                                       double sub = Double.parseDouble(lblTotal.getText());
                                       subTotal = sub + calculo;
                                       lblTotal.setText(String.valueOf(subTotal));
                                       
                                       Sentencias_Henry s = new Sentencias_Henry();
                                       s.setId_IMP(Integer.parseInt(tblInventario.getValueAt(filaa, 0).toString()));
...
// TODO add your handling code here:
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        Sentencias_Henry s = new Sentencias_Henry();
        s.setId_CM(Integer.parseInt(lblId.getText()));
        Funciones_Henry.isDeleteCompra(s);
        s.setFK_Id_CM(Integer.parseInt(lblId.getText()));
        Funciones_Henry.isDeleteDETALLECOMPRA(s);
        ...
        Funciones_Henry.isRegisterCompra(s);
            ...
            JOptionPane.showMessageDialog(null, "Compra Actualizada Con Exito");
...
//          
        //  double q = Double.parseDouble(tblDetalleCompra.getValueAt(i, 3).toString());
           ...
           // Funciones_Henry.isUpdateInventa(s);
            ...
            this.dispose();
            //JOptionPane.showMessageDialog(null, "Datos actualiizados");
...
// TODO add your handling code here:
	...
	r = JOptionPane.showConfirmDialog(this, "¿Desea quitar este producto de la compra?",
            ...
            Sentencias_Henry s = new Sentencias_Henry();            
            s.setId_DE(Integer.parseInt(tblDetalleCompra.getValueAt(tblDetalleCompra.getSelectedRow(), 0).toString()));
            s.setFK_Id_IMP(Integer.parseInt(tblDetalleCompra.getValueAt(tblDetalleCompra.getSelectedRow(), 2).toString()));
            
            s.setId_IMP(Integer.parseInt(tblDetalleCompra.getValueAt(tblDetalleCompra.getSelectedRow(), 2).toString()));
            Funciones_Henry.isUpdateInventario(s);
            
            s.setCantidad_DE(Double.parseDouble(tblDetalleCompra.getValueAt(tblDetalleCompra.getSelectedRow(), 3).toString()));
            
            double e = s.getExistencia_IMP();
//          JOptionPane.showMessageDialog(null, e);
//          
           double q = Double.parseDouble(tblDetalleCompra.getValueAt(tblDetalleCompra.getSelectedRow(), 3).toString());
           double Total = e-q;
            
            s.setPrecio_DE(Double.parseDouble(tblDetalleCompra.getValueAt(tblDetalleCompra.getSelectedRow(), 4).toString()));
            s.setTotal_DE(Double.parseDouble(tblDetalleCompra.getValueAt(tblDetalleCompra.getSelectedRow(), 5).toString()));
            s.setFK_Id_CM(Integer.parseInt(this.lblId.getText()));
            s.setExistencia_IMP(Total);
            Funciones_Henry.isUpdateInventa(s);
            Funciones_Henry.setListarInventarioupdate("");
        ...
        subTotal = Double.parseDouble(lblTotal.getText().toString()) - valor;
        lblTotal.setText(String.valueOf(subTotal));
    ...
    private void txtBusquedaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBusquedaKeyReleased
       Funciones_Henry.setListarInventarioupdate(txtBusqueda.getText());
        // TODO add your handling code here:
...
txtBusqueda.setText(txtBusqueda.getText().replaceAll("( )+", " "));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(COMPRA_MATERIA_PRIMA_UPDATE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new COMPRA_MATERIA_PRIMA_UPDATE().setVisible(true);
            }
        });
    }
public int i=0; 
...
public double totalF=0.00;
    ...
    public static javax.swing.JLabel lblFechaRegistro;
    ...
    public static com.toedter.calendar.JDateChooser txtFechaCompra;
